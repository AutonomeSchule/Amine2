...
namespace AmineV02.Controllers
{
    public class gaste2Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Nachname,Ankunft,Genre,Wunsch,Price,Phonenumber,Email,vegan")] Gaeste gaeste)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Nachname,Ankunft,Genre,Wunsch,Price,Phonenumber,Email,vegan")] Gaeste gaeste)
        {
            if (id != gaeste.ID)
            {
                return NotFound();
